			...
			<article className='row-start-2 row-end-3 col-start-2 col-end-3'>
				...
				<div className='flex flex-col gap-9 mt-16'>
					<input
						...
						className='block w-[60%] text-500  bg-transparent border-b-600 border-b-[2px] text-xl pb-3 outline-none'
					/>
					<input
						type='password'
						placeholder='Пароль'
				...
				<p className='text-[600] mt-7 text-lg'>
					Забыли пароль?
					<span className='text-accent ml-4 py-[3px] font-bold border-b-[2px] border-b-accent'>
						Восстановить
					</span>
				</p>
