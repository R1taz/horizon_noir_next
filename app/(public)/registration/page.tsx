			...
			<article className='row-start-2 row-end-3 col-start-2 col-end-3'>
				...
				<form onSubmit={handleSubmit(onSubmit)} className='flex flex-col gap-9 mt-16'>
					<input
						...
						placeholder='Имя'
						className='outline-none block w-[60%] text-500  bg-transparent border-b-600 border-b-[2px] text-xl pb-3'
					/>
					...
					<button
						type='submit'
						className='outline-none mt-5 rounded-[5px] bg-accent font-bold text-xl text-700 py-3 w-[320px]'
					>
						Зарегистрироваться
					</button>
				</form>
